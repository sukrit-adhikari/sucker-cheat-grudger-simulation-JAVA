...
public class SimulationStatistics {
   ...
   public static Integer averageSuckersPercentage=0;
   public static Integer averageCheatsPercentage=0;
   public static Integer averageGrudgersPercentage=0;
  ...
  public static void resetSimulationStatistics(){
   ...
   averageSuckersPercentage=0;
   averageCheatsPercentage=0;
   averageGrudgersPercentage=0;
