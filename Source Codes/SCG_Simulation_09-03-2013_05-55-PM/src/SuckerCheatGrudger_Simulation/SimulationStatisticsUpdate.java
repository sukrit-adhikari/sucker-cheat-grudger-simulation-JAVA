...
public class SimulationStatisticsUpdate {
    ...
    public static void updateSimulationStatistics(Individual iN,boolean birthOrDeath,String deathByNaturalOrInfectionOrAgeing){
        ...
        if(birthOrDeath){
            ...
            }else if(deathByNaturalOrInfectionOrAgeing=="ageing"){
                SimulationStatistics.noOfDeaths_Ageing++;
            }else if(deathByNaturalOrInfectionOrAgeing=="infection"){
                SimulationStatistics.noOfDeaths_Infection++;
            }
        }
